...
import uuid
from core.models.validators.medical_record import validate_encounters, validate_medical_history
...
class MedicalRecord(models.Model):
    ...
    encounters = models.JSONField(
        default=default_encounter, blank=True, null=True, serialize=True,
        validators=[validate_encounters]
    )
    allergies = models.ManyToManyField("Allergies", blank=True)
    medical_history = models.JSONField(
        default=default_medical_history, blank=True, null=True, serialize=True,
